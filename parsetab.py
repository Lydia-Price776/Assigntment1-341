...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','plyparser.py',42),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','plyparser.py',46),
  ('expression -> term','expression',1,'p_expression_term','plyparser.py',50),
  ('term -> term TIMES factor','term',3,'p_term_times','plyparser.py',54),
  ('term -> term DIVIDE factor','term',3,'p_term_div','plyparser.py',58),
  ('term -> factor','term',1,'p_term_factor','plyparser.py',62),
  ('factor -> NUMBER','factor',1,'p_factor_num','plyparser.py',66),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','plyparser.py',70),
]
